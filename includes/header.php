    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-3">
          <div class="logo"><a href="index.php"><img src="admin/img/logo-new.png" width="50px" height="50px" alt="image"/></a> </div>
        </div>
        <div class="col-sm-8 col-md-8">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:ask@menaratnt.com">ask@kursus-mobil.com</a> </div>
            <div class="header_widgets">
