  ...
  <div class="container">
	...
	<div class="col-list-3">
		<div class="recent-car-list">
			<div class="car-info-box"><a href="paket_detail.php?id=<?php echo htmlentities($results['id_paket']);?>"><img src="admin/gallery/<?php echo htmlentities($results['foto_paket']);?>" class="img-responsive" alt="image"></a>
			<ul>
			<li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($results['jml_latihan']);?> Kali Pertemuan</li>
			</ul>
			</div>
